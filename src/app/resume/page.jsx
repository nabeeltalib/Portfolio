...
const experience = {
  ...
  title: "My Experience",
  description:
    "Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis, veniam accusamus. Temporibus molestias nostrum magni.",
  items: [
    {
...
const skill = {
  title: "My Skill",
  description:
    "Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium error, commodi fugiat cum veniam aliquid!",
  skillList: [
    {
      icon: <FaHtml5 />,
      name: "HTML 5",
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-3">
                            <span className="w-[6px] h-[6px] rounded-full bg-[#fe2054]"></span>
                ...
                <ul className="grid grid-cols-2 gap-10 sm:grid-cols-3 md:grid-cols-4 xl:gap-[30px]">
                  {skill.skillList.map((skill, index) => {
                    return (
                      <li
                        key={index}
                        className="w-full h-[150px] bg-[#232329] group rounded-lg flex flex-col gap-4 justify-center items-center"
                      >
                        <div className="text-6xl group-hover:text-[#fe2054] transition-all duration-50">
                          {skill.icon}
                        </div>
                ...
                <ul className="grid grid-cols-2 gap-10 xl:gap-[30px] xl:grid-cols-4">
                  {about.info.map((item, index) => {
                    return (
                      <li
                        key={index}
                        className="flex flex-row justify-center gap-10 xl:flex xl:flex-col flex-wrap"
                      >
